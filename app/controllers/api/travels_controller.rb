class Api::TravelsController < Api::ApiController
  ...
  def approve_user
    ...
    PickAppMailer.send_email(applying.email, title, body, link, applying.device_tokens).deliver_now
  ...
  def apply_user
    ...
    PickAppMailer.send_email(@travel.driver.email, title, body, link, @travel.driver.device_tokens).deliver_now
